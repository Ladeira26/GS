...
O programa solicita ao usuário o cadastro de eventos ambientais, armazenando informações como:
- Tipo do evento
- Localização
- Área afetada
- Intensidade
...
Após o cadastro, o sistema realiza análises automáticas, incluindo:
